...
Die einfachste Methode um Tor zu benutzen ist der [Tor Browser](https://www.torproject.org/). Dieser ist eine angepasste Version des Firefox, der aber den kompletten Verkehr durch das Tor Netzwerk leitet. Zusätzlich speichert der Browser selbst keine Daten dauerhaft auf Eurem System.

Der offensichtlichste Nachteil: Die Verbindungen über Tor sind langsamer als 'normales' Internet.

Grundsätzlich solltest du bedenken, dass mögliche Überwacher Deines Anschlusses sehen können dass du Tor benutzt. Allerdings können sie nicht sehen was du mit Tor tust, denn die Verbindung ins Netzwerk ist verschlüsselt. Die Nutzung von Tor an sich macht dich nicht verdächtig, denn außer dir machen das alleine [in Deutschland über 150.000 Meschen täglich](https://metrics.torproject.org/userstats-relay-country.html?country=de&events=off).

Wichtig:
- Security Level mindestens 'Safer' besser 'Safest'
- Keine Addons installieren
- Einstellungen des Brosers nicht ändern
