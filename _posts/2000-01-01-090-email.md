...
**Thunderbird nutz ab der Version 78 einen eigenen keyring eventuell müssen schlüssel aus gpgp exportiert und in thunderbird importiert werden wenn ihr vorher Enigmail genutzt habt**
1. Thunderbird installieren und mit deinem E-Mail-Konto verbinden
2. In den Konteneinstellungen unter Ende-zu-Ende Verschlüsselung eine Schlüssel hinzufügen
3. Den Schlüssel in den Einstellungen auswählen
4. Schlüssel können über das Menü “Konten-Einstellungen -> Ende-zu_ende Verschlüsselung -> OpenPGP Schlüssel Verwalten” importiert und exportiert werden.
5. Achte auch darauf das du die Schlüsselakzeptanz mindestens auf "Ja, aber ich habe nicht überprüft ob es sich im den korrekten Schlüssel handelt." gesetzt ist
6. An dich gerichtete verschlüsselte Nachrichten werden beim Empfang automatisch entschlüsselt
7. E-Mails die du schreibst sollten automatisch verschlüsselt werden sofern du den entsprechenden öffentlichen Schlüssel importiert hast und dieser Akzeptiert ist. Achte auf das Schloss Symbol über der E-Mail.
