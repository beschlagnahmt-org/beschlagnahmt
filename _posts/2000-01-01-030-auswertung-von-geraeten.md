...
| **AFU** | Auslesbar | 
| **Verteidigung** | &bull; Grundsätzlich: Ungenutzte Geräte herunter fahren<br> &bull; BFU: Lange Passphrase, siehe [Passwörter](/passwort/) | 

### Windows

| **BFU** | Auslesbar |
| **AFU** | Auslesbar | 
| **Verteidigung** | &bull; Auf Linux wechseln<br>  &bull; BFU: VeraCrypt, siehe [Daten verschlüsseln](/daten-verschluesseln/) |
